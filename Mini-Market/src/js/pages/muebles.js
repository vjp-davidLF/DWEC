...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Traemos los productos de muebles desde el servidor
    ...
    if (productos.length > 0) {
        productos.forEach(producto => {
            ...
            card.innerHTML = `
                ...
                <div class="producto-info">
                    <p class="producto-categoria">Muebles</p>
        ...
        contenedor.innerHTML = '<p class="no-productos">No hay productos de muebles disponibles.</p>';
    }
